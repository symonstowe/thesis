...
\citeauthorandyear{grychtol_fem_2013} where mesh density was
...
To calculate the sensitivity error, the difference in sensitivity was computed between the 
...
error was achieved with a balance point of approximately 70\% for Netgen. This can be seen in \fref{fig:balance_sens}.
This was mainly 
...
and electrodes. An example mesh is shown in \fref{fig:adv_mesh} 
that depicts 
