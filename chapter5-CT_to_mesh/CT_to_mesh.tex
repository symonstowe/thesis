...
shown in \fref{fig:c-of-m-error}. The error is estimated as the distance in pixels 
...
The center of mass error was not significantly different across all models for each of the subjects. 
