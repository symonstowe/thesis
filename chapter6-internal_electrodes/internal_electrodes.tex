...
In simulations on a tank model, \TODO{also have un processed tank data...}
...
Currently the most common use of EIT is
...
Several works have shown that motion \TODO{ref from notes on percent electrode movement}
...
electrodes~\parencite{nguyen_review_2012}. % TODO 
