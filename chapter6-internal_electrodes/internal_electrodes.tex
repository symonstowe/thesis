...
This results in the same number of measurements, but many more measurements
...
\Fref{fig:internal_sensitivity} show internal sensitivity distribution changes when 
